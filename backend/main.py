...
@app.get("/api/quote/{quote_id}", tags=["Public"])
...
@app.get("/api/all_quotes", tags=["Public"])
...
@app.delete("/api/quote/{quote_id}", tags=["Admin"])
def delete_quote(
...
@app.put("/api/quote/{quote_id}", tags=["Admin"])
